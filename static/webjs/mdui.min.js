...
!function (t, e) {
    ...
    !function () {
        var t = 0;
        window.requestAnimationFrame || (window.requestAnimationFrame = window.webkitRequestAnimationFrame, window.cancelAnimationFrame = window.webkitCancelAnimationFrame), window.requestAnimationFrame || (window.requestAnimationFrame = function (e, n) {
            var i = (new Date).getTime(), o = Math.max(0, 16.7 - (i - t)), a = window.setTimeout(function () {
                e(i + o)
            }, o);
            return t = i + o, a
    ...
    var e = function (t, e, n) {
        ...
        function o(t, e) {
            ...
            } else for (o in t) if (t.hasOwnProperty(o) && !1 === e.call(t[o], o, t[o])) return t;
            return t
        }
        ...
        function v(t) {
            var n, i;
            return w[t] || (n = e.createElement(t), e.body.appendChild(n), i = getComputedStyle(n, "").getPropertyValue("display"), n.parentNode.removeChild(n), "none" === i && (i = "block"), w[t] = i), w[t]
        }

        var g = [], b = g.slice, x = g.concat, y = Array.isArray, $ = e.documentElement, w = {}, C = function (t) {
            for (var e = this, n = 0; n < t.length; n++) e[n] = t[n];
            ...
            if (l(n)) {
                ...
                if ("<" === (n = n.trim())[0] && ">" === n[n.length - 1]) {
                    var r = "div";
                    for (0 === n.indexOf("<li") && (r = "ul"), 0 === n.indexOf("<tr") && (r = "tbody"), 0 !== n.indexOf("<td") && 0 !== n.indexOf("<th") || (r = "tr"), 0 === n.indexOf("<tbody") && (r = "table"), 0 === n.indexOf("<option") && (r = "select"), (s = e.createElement(r)).innerHTML = n, o = 0; o < s.childNodes.length; o++) i.push(s.childNodes[o])
                } else for (a = "#" !== n[0] || n.match(/[ .<>:~]/) ? e.querySelectorAll(n) : [e.getElementById(n.slice(1))], o = 0; o < a.length; o++) a[o] && i.push(a[o])
            } else {
                if (u(n)) return k(e).ready(n);
                if (n.nodeType || n === t || n === e) i.push(n); else if (n.length > 0 && n[0].nodeType) for (o = 0; o < n.length; o++) i.push(n[o])
            }
            return new C(i)
        };
        k.fn = C.prototype, k.extend = k.fn.extend = function (t) {
            ...
            each: o, merge: s, unique: r, map: a, contains: function (t, e) {
            ...
            each: function (t) {
                ...
                if (this[0]) {
                    ...
                    return {left: e.left + t.pageXOffset, top: e.top + t.pageYOffset, width: e.width, height: e.height}
                }
                return null
            }, offsetParent: function () {
                return this.map(function () {
                    for (var t = this.offsetParent; t && "static" === k(t).css("position");) t = t.offsetParent;
                    return t || $
                })
            }, position: function () {
                var t = this;
                ...
                return "fixed" === t.css("position") ? n = t[0].getBoundingClientRect() : (e = t.offsetParent(), n = t.offset(), d(e[0], "html") || (i = e.offset()), i = {
                ...
                var a = this[0];
                if (!a || o === n || null === o) return !1;
                var s, r;
                if (l(o)) return a !== e && a !== t && (a.matches || a.matchesSelector || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector).call(a, o);
                if (o === e || o === t) return a === o;
                if (o.nodeType || i(o)) {
                    for (s = o.nodeType ? [o] : o, r = 0; r < s.length; r++) if (s[r] === a) return !0;
                    return !1
                }
                return !1
            }, find: function (t) {
                ...
                var e = l(t) ? this.find(t) : k(t), n = e.length;
                ...
                return i && i.elements ? (k(b.call(i.elements)).each(function () {
                    t = k(this), e = t.attr("type"), "fieldset" === this.nodeName.toLowerCase() || this.disabled || -1 !== ["submit", "reset", "button"].indexOf(e) || -1 !== ["radio", "checkbox"].indexOf(e) && !this.checked || n.push({
                        name: t.attr("name"),
                        value: t.val()
                    })
                }), n) : n
            ...
            var i = {0: "value", 1: "innerHTML", 2: "textContent"}, o = {0: n, 1: n, 2: null};
            k.fn[e] = function (e) {
            ...
            k.fn[i] = function (o) {
                if (o === n) {
                    var a = this[0];
                    if (h(a)) return a["inner" + e];
                    if (m(a)) return a.documentElement["scroll" + e];
                    var s = k(a), r = 0, c = "width" === i;
                    return "ActiveXObject" in t && "border-box" === s.css("box-sizing") && (r = parseFloat(s.css("padding-" + (c ? "left" : "top"))) + parseFloat(s.css("padding-" + (c ? "right" : "bottom"))) + parseFloat(s.css("border-" + (c ? "left" : "top") + "-width")) + parseFloat(s.css("border-" + (c ? "right" : "bottom") + "-width"))), parseFloat(k(a).css(i)) + r
                }
                return isNaN(Number(o)) || "" === o || (o += "px"), this.css(i, o)
            }
        }), o({Width: "width", Height: "height"}, function (t, e) {
            k.fn["inner" + t] = function () {
                var t = this[e](), n = k(this[0]);
                return "border-box" !== n.css("box-sizing") && (t += parseFloat(n.css("padding-" + ("width" === e ? "left" : "top"))), t += parseFloat(n.css("padding-" + ("width" === e ? "right" : "bottom")))), t
            }
        });
        ...
        return o(["", "All", "Until"], function (t, e) {
            ...
            k.fn[n] = function (n) {
                ...
                if (l(n)) {
                    ...
                    s.innerHTML = n, i = b.call(s.childNodes)
                } else i = k(n).get();
                return 1 === t && i.reverse(), this.each(function (e, n) {
                    o(i, function (i, o) {
            ...
            function i(t, e, i, o, a) {
                ...
                c[r] || (c[r] = []);
                var d = !1;
                p(o) && o.useCapture && (d = !0), e.split(" ").forEach(function (e) {
                    var s = {e: e, fn: i, sel: a, i: c[r].length}, u = function (t, e) {
            ...
            k.fn.extend({
                ready: function (t) {
                    ...
                    var c = this;
                    if (t && !l(t)) return o(t, function (t, n) {
                        c.on(t, e, a, n)
                    }), c;
                    if (l(e) || u(s) || !1 === s || (s = a, a = e, e = n), (u(a) || !1 === a) && (s = a, a = n), !1 === s && (s = f), 1 === r) {
                        var d = s;
                        s = function () {
                            return c.off(t, e, s), d.apply(this, arguments)
                        }
                    }
                    return this.each(function () {
                        i(this, t, s, a, e)
                    ...
                    if (l(n)) {
                        var o;
                        if (["click", "mousedown", "mouseup", "mousemove"].indexOf(n) > -1) try {
            ...
            k.extend({
                ajaxSetup: function (t) {
                    ...
                    function p(t) {
                        var e, n, i = arguments;
                        t && (t in g && (e = g[t](i[1], i[2], i[3], i[4])), d[t] && (n = d[t](i[1], i[2], i[3], i[4])), "beforeSend" !== t || !1 !== e && !1 !== n || (v = !0))
                    }
                    ...
                    var h = {
                        ...
                        timeout: 0,
                        global: !0
                    }, m = ["beforeSend", "success", "error", "statusCode", "complete"], v = !1, g = i, b = {};
                    o(g, function (t, e) {
                        m.indexOf(t) < 0 && (h[t] = e)
                    });
                    ...
                    var y;
                    if (y = (r(x) || d.processData) && d.data && [ArrayBuffer, Blob, Document, FormData].indexOf(d.data.constructor) < 0 ? l(d.data) ? d.data : k.param(d.data) : d.data, r(x) && y && (d.url = c(d.url, y), y = null), "jsonp" === d.dataType) {
                        var $ = u(d.jsonpCallback) ? d.jsonpCallback() : d.jsonpCallback,
                            w = c(d.url, d.jsonp + "=" + $);
                        if (b.options = d, f(s.ajaxStart, b), p("beforeSend", null), v) return;
                        var C, O = e.createElement("script");
                        return O.type = "text/javascript", O.onerror = function () {
                    ...
                    T.open(x, d.url, d.async, d.username, d.password), (y && !r(x) && !1 !== d.contentType || d.contentType) && T.setRequestHeader("Content-Type", d.contentType), "json" === d.dataType && T.setRequestHeader("Accept", "application/json, text/javascript"), d.headers && o(d.headers, function (t, e) {
                    ...
                    return T.onload = function () {
                        ...
                        } else t = "error", f(s.ajaxError, b), p("error", T, t);
                        ...
                        var t = "abort";
                        E && (t = "timeout", clearTimeout(E)), f(s.ajaxError, b), p("error", T, t), f(s.ajaxComplete, b), p("complete", T, t)
    ...
    }(window, document), n = e(document), i = e(window), o = {};
    !function () {
        var t = [];
        o.queue = function (e, n) {
            if (void 0 === t[e] && (t[e] = []), void 0 === n) return t[e];
            t[e].push(n)
    ...
    var a = {
        ...
        isAllow: function (t) {
            var e = !0;
            return a.touches && ["mousedown", "mouseup", "mousemove", "click", "mouseover", "mouseout", "mouseenter", "mouseleave"].indexOf(t.type) > -1 && (e = !1), e
        },
        register: function (t) {
    ...
    var s = function (t) {
        ...
        a || (a = {}), a.inst = i;
        var s = t + ".mdui." + n;
        "undefined" != typeof jQuery && jQuery(o).trigger(s, a), e(o).trigger(s, a)
    };
    e.fn.extend({
        reflow: function () {
            return this.each(function () {
            ...
            function e(a) {
                if (a.target === this) for (t.call(this, a), n = 0; n < i.length; n++) o.off(i[n], e)
            }

            var n, i = ["webkitTransitionEnd", "transitionend"], o = this;
            if (t) for (n = 0; n < i.length; n++) o.on(i[n], e);
            return this
        ...
        showOverlay: function (t) {
            ...
            n.length ? (n.data("isDeleted", 0), void 0 !== t && n.css("z-index", t)) : (void 0 === t && (t = 2e3), n = e('<div class="mdui-overlay">').appendTo(document.body).reflow().css("z-index", t));
        ...
        e.extend({
            guid: function (e) {
                ...
                if (void 0 !== e && void 0 !== t[e]) return t[e];
                var i = n() + n() + "-" + n() + "-" + n() + "-" + n() + "-" + n() + n() + n();
                return void 0 !== e && (t[e] = i), i
            }
        })
    }(), function () {
        function n(t, n, i, o, a) {
            var s = e(i), r = s.data("mdui.mutation");
            r || (r = [], s.data("mdui.mutation", r)), -1 === r.indexOf(t) && (r.push(t), n.call(i, o, a))
        }
        ...
        function t(t, i) {
            var o = this;
            if (o.$headroom = e(t).eq(0), o.$headroom.length) {
                var a = o.$headroom.data("mdui.headroom");
                if (a) return a;
                o.options = e.extend({}, n, i || {});
                var s = o.options.tolerance;
                s !== Object(s) && (o.options.tolerance = {down: s, up: s}), o._init()
            }
        }
        ...
        t.prototype._init = function () {
            ...
            var t = this;
            t.inited || (t.lastScrollY = window.pageYOffset, t.inited = !0, i.on("scroll", function () {
                t._scroll()
            }))
        }, t.prototype._scroll = function () {
            var t = this;
            t.rafId = window.requestAnimationFrame(function () {
                var e = window.pageYOffset, n = e > t.lastScrollY ? "down" : "up",
                    i = Math.abs(e - t.lastScrollY) >= t.options.tolerance[n];
                e > t.lastScrollY && e >= t.options.offset && i ? t.unpin() : (e < t.lastScrollY && i || e <= t.options.offset) && t.pin(), t.lastScrollY = e
            })
        };
        var o = function (t) {
        ...
        return t.prototype.pin = function () {
            var t = this;
            "pinning" !== t.state && "pinned" !== t.state && t.$headroom.hasClass(t.options.initialClass) && (r("pin", "headroom", t, t.$headroom), t.state = "pinning", t.$headroom.removeClass(t.options.unpinnedClass).addClass(t.options.pinnedClass).transitionEnd(function () {
                o(t)
            }))
        }, t.prototype.unpin = function () {
            var t = this;
            "unpinning" !== t.state && "unpinned" !== t.state && t.$headroom.hasClass(t.options.initialClass) && (r("unpin", "headroom", t, t.$headroom), t.state = "unpinning", t.$headroom.removeClass(t.options.pinnedClass).addClass(t.options.unpinnedClass).transitionEnd(function () {
                o(t)
            }))
            ...
            var t = this;
            t.inited && (t.inited = !1, t.$headroom.removeClass([t.options.initialClass, t.options.pinnedClass, t.options.unpinnedClass].join(" ")), i.off("scroll", function () {
                t._scroll()
        ...
        t.mutation("[mdui-headroom]", function () {
            var n = e(this), i = s(n.attr("mdui-headroom")), o = n.data("mdui.headroom");
            o || (o = new t.Headroom(n, i), n.data("mdui.headroom", o))
        })
    });
    var c = function () {
        function t(t, i, o) {
            ...
            if (a.class_item = s, a.class_item_open = s + "-open", a.class_header = s + "-header", a.class_body = s + "-body", a.$collapse = e(t).eq(0), a.$collapse.length) {
                var r = a.$collapse.data("mdui." + a.ns);
                if (r) return r;
                a.options = e.extend({}, n, i || {}), a.$collapse.on("click", "." + a.class_header, function () {
        ...
        return t.prototype.open = function (t) {
            ...
            if (e._isOpen(n)) {
                ...
                r("close", e.ns, e, n[0]), n.removeClass(e.class_item_open), o.transition(0).height(o[0].scrollHeight).reflow().transition("").height("").transitionEnd(function () {
                    i(e, o, n)
                })
            }
    ...
    return t.Collapse = function () {
        ...
        t.mutation("[mdui-collapse]", function () {
            var n = e(this), i = n.data("mdui.collapse");
            if (!i) {
                var o = s(n.attr("mdui-collapse"));
                i = new t.Collapse(n, o), n.data("mdui.collapse", i)
            }
        })
    }), function () {
        function n(t) {
            var n = this;
            n.$table = e(t).eq(0), n.$table.length && n.init()
        }
        ...
        n.prototype.init = function () {
            var t = this;
            t.$thRow = t.$table.find("thead tr"), t.$tdRows = t.$table.find("tbody tr"), t.$tdCheckboxs = e(), t.selectable = t.$table.hasClass("mdui-table-selectable"), t.selectedRow = 0, t._updateThCheckbox(), t._updateTdCheckbox(), t._updateNumericCol()
        }, n.prototype._updateTdCheckbox = function () {
            var t = this;
            t.$tdRows.each(function () {
                var n = e(this);
                if (n.find(".mdui-table-cell-checkbox").remove(), t.selectable) {
                    var o = e(i("td")).prependTo(n).find('input[type="checkbox"]');
                    n.hasClass("mdui-table-row-selected") && (o[0].checked = !0, t.selectedRow++), t.$thCheckbox[0].checked = t.selectedRow === t.$tdRows.length, o.on("change", function () {
            ...
            var t = this;
            t.$thRow.find(".mdui-table-cell-checkbox").remove(), t.selectable && (t.$thCheckbox = e(i("th")).prependTo(t.$thRow).find('input[type="checkbox"]').on("change", function () {
            ...
            e(arguments.length ? arguments[0] : ".mdui-table").each(function () {
                var t = e(this), i = t.data("mdui.table");
        ...
        var i = {
            delay: 200, show: function (t, n) {
                if (2 !== t.button) {
                    var i, o = (i = "touches" in t && t.touches.length ? t.touches[0] : t).pageX, a = i.pageY,
                        s = n.offset(), r = {x: o - s.left, y: a - s.top}, c = n.innerHeight(), d = n.innerWidth(),
                        u = Math.max(Math.pow(Math.pow(c, 2) + Math.pow(d, 2), .5), 48),
                        l = "translate3d(" + (d / 2 - r.x) + "px, " + (c / 2 - r.y) + "px, 0) scale(1)";
            ...
            if (a.isAllow(t) && (a.register(t), t.target !== document)) {
                ...
                if ((n = o.hasClass("mdui-ripple") ? o : o.parents(".mdui-ripple").eq(0)).length) {
                    ...
                    if ("touchstart" === t.type) {
                        var s = !1, r = setTimeout(function () {
                            r = null, i.show(t, n)
                        }, i.delay), c = function (e) {
        ...
        n.on("input focus blur", ".mdui-textfield-input", {useCapture: !0}, function (t) {
            var n = t.target, o = e(n), a = t.type, s = o.val(), r = i(t.detail, "reInit"),
                c = i(t.detail, "domLoadedEvent"), d = o.attr("type") || "";
            if (!(["checkbox", "button", "submit", "range", "radio", "image"].indexOf(d) >= 0)) {
                var u = o.parent(".mdui-textfield");
                if ("focus" === a && u.addClass("mdui-textfield-focus"), "blur" === a && u.removeClass("mdui-textfield-focus"), "blur" !== a && "input" !== a || u[s && "" !== s ? "addClass" : "removeClass"]("mdui-textfield-not-empty"), u[n.disabled ? "addClass" : "removeClass"]("mdui-textfield-disabled"), "input" !== a && "blur" !== a || c || n.validity && u[n.validity.valid ? "removeClass" : "addClass"]("mdui-textfield-invalid-html5"), "textarea" === t.target.nodeName.toLowerCase()) {
                    var l = o.val(), f = !1;
                    "" === l.replace(/[\r\n]/g, "") && (o.val(" " + l), f = !0), o.height("");
                    var p = o.height(), h = n.scrollHeight;
                    h > p && o.height(h), f && o.val(l)
                }
        ...
        var i = function (t) {
            var e = t.data(), n = e.$track, i = e.$fill, o = e.$thumb, a = e.$input, s = e.min, r = e.max,
                c = e.disabled, d = e.discrete, u = e.$thumbText, l = a.val(), f = (l - s) / (r - s) * 100;
            i.width(f + "%"), n.width(100 - f + "%"), c && (i.css("padding-right", "6px"), n.css("padding-left", "6px")), o.css("left", f + "%"), d && u.text(l), t[0 === parseFloat(f) ? "addClass" : "removeClass"]("mdui-slider-zero")
        }, o = function (t) {
            var n = e('<div class="mdui-slider-track"></div>'), o = e('<div class="mdui-slider-fill"></div>'),
                a = e('<div class="mdui-slider-thumb"></div>'), s = t.find('input[type="range"]'), r = s[0].disabled;
            t[r ? "addClass" : "removeClass"]("mdui-slider-disabled"), t.find(".mdui-slider-track").remove(), t.find(".mdui-slider-fill").remove(), t.find(".mdui-slider-thumb").remove(), t.append(n).append(o).append(a);
            var c, d = t.hasClass("mdui-slider-discrete");
            d && (c = e("<span></span>"), a.empty().append(c)), t.data({
                $track: n,
                $fill: o,
                $thumb: a,
                $input: s,
        ...
        function t(t, o) {
            var s = this;
            if (s.$fab = e(t).eq(0), s.$fab.length) {
                var r = s.$fab.data("mdui.fab");
                if (r) return r;
                s.options = e.extend({}, i, o || {}), s.state = "closed", s.$btn = s.$fab.find(".mdui-fab"), s.$dial = s.$fab.find(".mdui-fab-dial"), s.$dialBtns = s.$dial.find(".mdui-fab"), "hover" === s.options.trigger && (s.$btn.on("touchstart mouseenter", function () {
                    s.open()
        ...
        n.on("touchstart mousedown mouseover", "[mdui-fab]", function (n) {
            var i = e(this), o = i.data("mdui.fab");
            if (!o) {
                var a = s(i.attr("mdui-fab"));
                o = new t.Fab(i, a), i.data("mdui.fab", o)
            }
        })
    }), t.Select = function () {
        function t(t, i) {
            var a = this, s = a.$selectNative = e(t).eq(0);
            if (s.length) {
                var r = s.data("mdui.select");
                if (r) return r;
                s.hide(), a.options = e.extend({}, o, i || {}), a.uniqueID = e.guid(), a.state = "closed", a.handleUpdate(), n.on("click touchstart", function (t) {
                    var n = e(t.target);
        ...
        var o = {position: "auto", gutter: 16}, a = function (t) {
            var e, n, o = i.height(), a = t.options.gutter, s = t.options.position, r = parseInt(t.$select.height()),
                c = t.$items.eq(0), d = parseInt(c.height()), u = parseInt(c.css("margin-top")),
                l = parseFloat(t.$select.width() + .01), f = d * t.size + 2 * u,
                p = t.$select[0].getBoundingClientRect().top;
            if ("auto" === s) {
                var h = o - 2 * a;
                f > h && (f = h), n = -(u + t.selectedIndex * d + (d - r) / 2);
                var m = -(u + (t.size - 1) * d + (d - r) / 2);
                n < m && (n = m);
                var v = p + n;
                v < a ? n = -(p - a) : v + f + a > o && (n = -(p + f + a - o)), e = t.selectedIndex * d + d / 2 + u + "px"
            } else "bottom" === s ? (n = r, e = "0px") : "top" === s && (n = -f - 1, e = "100%");
            t.$select.width(l), t.$menu.width(l).height(f).css({
                "margin-top": n + "px",
        ...
        t.prototype.handleUpdate = function () {
            ...
            t.value = n.val(), t.text = "", t.$items = e(), n.find("option").each(function (n, i) {
                var o = {
                    value: i.value,
                    text: i.textContent,
                    disabled: i.disabled,
                ...
                t.value === o.value && (t.text = o.text, t.selectedIndex = n), t.$items = t.$items.add(e('<div class="mdui-select-menu-item mdui-ripple"' + (o.disabled ? " disabled" : "") + (o.selected ? " selected" : "") + ">" + o.text + "</div>").data(o))
                ...
                if ("closing" !== t.state) {
                    ...
                    if (!i.data("disabled")) {
                        var o = i.data();
                        t.$selected.text(o.text), n.val(o.value), t.$items.removeAttr("selected"), i.attr("selected", ""), t.selectedIndex = o.index, t.value = o.value, t.text = o.text, n.trigger("change"), t.close()
                    }
                }
        ...
        var s = function (t) {
            t.$select.removeClass("mdui-select-closing"), "opening" === t.state && (t.state = "opened", r("opened", "select", t, t.$selectNative), t.$menu.css("overflow-y", "auto")), "closing" === t.state && (t.state = "closed", r("closed", "select", t, t.$selectNative), t.$select.width(""), t.$menu.css({
                "margin-top": "",
                height: "",
                width: ""
            }))
        ...
        return t.prototype.open = function () {
            var t = this;
            "opening" !== t.state && "opened" !== t.state && (t.state = "opening", r("open", "select", t, t.$selectNative), a(t), t.$select.addClass("mdui-select-open"), t.$menu.transitionEnd(function () {
                s(t)
            }))
        }, t.prototype.close = function () {
            var t = this;
            "closing" !== t.state && "closed" !== t.state && (t.state = "closing", r("close", "select", t, t.$selectNative), t.$menu.css("overflow-y", ""), t.$select.removeClass("mdui-select-open").addClass("mdui-select-closing"), t.$menu.transitionEnd(function () {
                s(t)
            }))
        }, t.prototype.toggle = function () {
            var t = this;
        ...
        t.mutation("[mdui-select]", function () {
            var n = e(this), i = n.data("mdui.select");
            i || (i = new t.Select(n, s(n.attr("mdui-select"))), n.data("mdui.select", i))
        })
    }), e(function () {
        t.mutation(".mdui-appbar-scroll-hide", function () {
            ...
            var n = e(this), i = new t.Headroom(n, {
        ...
        function t(t, o) {
            var a = this;
            if (a.$tab = e(t).eq(0), a.$tab.length) {
                var s = a.$tab.data("mdui.tab");
                if (s) return s;
                a.options = e.extend({}, n, o || {}), a.$tabs = a.$tab.children("a"), a.$indicator = e('<div class="mdui-tab-indicator"></div>').appendTo(a.$tab), a.activeIndex = !1;
                var r = location.hash;
        ...
        return t.prototype._bindTabEvent = function (t) {
            ...
            t.$tabs.each(function (n, i) {
                var a = e(i), s = a.attr("href");
                n !== t.activeIndex || o(a) ? (a.removeClass("mdui-tab-active"), e(s).hide()) : (a.hasClass("mdui-tab-active") || (r("change", "tab", t, t.$tab, {
                    index: t.activeIndex,
                    id: s.substr(1)
                }), r("show", "tab", t, a), a.addClass("mdui-tab-active")), e(s).show(), t._setIndicatorPosition())
            })
        }, t.prototype._setIndicatorPosition = function () {
            var t, e, n = this;
            !1 !== n.activeIndex ? (t = n.$tabs.eq(n.activeIndex), o(t) || (e = t.offset(), n.$indicator.css({
            ...
            var t = this;
            !1 !== t.activeIndex && (t.activeIndex > 0 ? t.activeIndex-- : t.options.loop && (t.activeIndex = t.$tabs.length - 1), t._setActive())
            ...
            var t = this, e = t.$tabs, n = t.$tab.children("a"), i = e.get(), o = n.get();
        ...
        t.mutation("[mdui-tab]", function () {
            var n = e(this), i = n.data("mdui.tab");
            i || (i = new t.Tab(n, s(n.attr("mdui-tab"))), n.data("mdui.tab", i))
        })
    }), t.Drawer = function () {
        function t(t, s) {
            var r = this;
            if (r.$drawer = e(t).eq(0), r.$drawer.length) {
                var c = r.$drawer.data("mdui.drawer");
                if (c) return c;
                r.options = e.extend({}, n, s || {}), r.overlay = !1, r.position = r.$drawer.hasClass("mdui-drawer-right") ? "right" : "left", r.$drawer.hasClass("mdui-drawer-close") ? r.state = "closed" : r.$drawer.hasClass("mdui-drawer-open") ? r.state = "opened" : o() ? r.state = "opened" : r.state = "closed", i.on("resize", e.throttle(function () {
        ...
        var n = {overlay: !1, swipe: !1}, o = function () {
            return i.width() >= 1024
        }, a = function (t) {
            function n(e, n) {
            ...
            function s(e) {
                u = e.touches[0].pageX, "right" === t.position && (u = m.width() - u), l = e.touches[0].pageY, "opened" !== t.state && (u > v || d !== s) || (h = !0, m.on({
                    touchmove: r,
                    touchend: c,
                    touchcancel: r
                }))
            ...
            function r(i) {
                ...
                if (p) n(a(o), !0); else if (h) {
                    var r = Math.abs(o - u), d = Math.abs(s - l);
                    r > 8 && d <= 8 ? (f = o, p = "opened" === t.state ? "closing" : "opening", e.lockScreen(), n(a(o), !0)) : r <= 8 && d > 8 && c()
                }
            }
            ...
            function c(n) {
                if (p) {
                    ...
                    h = !1;
                    var u = p;
                    p = null, "opening" === u ? d < .92 ? (i(), t.open()) : i() : d > .08 ? (i(), t.close()) : i(), e.unlockScreen()
                } else h = !1;
                m.off({touchmove: r, touchend: c, touchcancel: r})
            }

            var d, u, l, f, p = !1, h = !1, m = e("body"), v = 24;
            t.options.swipe && (d || (m.on("touchstart", s), d = s))
        }, s = function (t) {
            t.$drawer.hasClass("mdui-drawer-open") ? (t.state = "opened", r("opened", "drawer", t, t.$drawer)) : (t.state = "closed", r("closed", "drawer", t, t.$drawer))
        };
        return t.prototype.open = function () {
            var t = this;
            "opening" !== t.state && "opened" !== t.state && (t.state = "opening", r("open", "drawer", t, t.$drawer), t.options.overlay || e("body").addClass("mdui-drawer-body-" + t.position), t.$drawer.removeClass("mdui-drawer-close").addClass("mdui-drawer-open").transitionEnd(function () {
                s(t)
            ...
            var t = this;
            "closing" !== t.state && "closed" !== t.state && (t.state = "closing", r("close", "drawer", t, t.$drawer), t.options.overlay || e("body").removeClass("mdui-drawer-body-" + t.position), t.$drawer.addClass("mdui-drawer-close").removeClass("mdui-drawer-open").transitionEnd(function () {
                s(t)
        ...
        t.mutation("[mdui-drawer]", function () {
            var n = e(this), i = s(n.attr("mdui-drawer")), o = i.target;
            delete i.target;
            var a = e(o).eq(0), r = a.data("mdui.drawer");
            r || (r = new t.Drawer(a, i), a.data("mdui.drawer", r)), n.on("click", function () {
                r.toggle()
            })
        })
    }), t.Dialog = function () {
        function t(t, n) {
            var i = this;
            if (i.$dialog = e(t).eq(0), i.$dialog.length) {
                var o = i.$dialog.data("mdui.dialog");
                if (o) return o;
                e.contains(document.body, i.$dialog[0]) || (i.append = !0, e("body").append(i.$dialog)), i.options = e.extend({}, d, n || {}), i.state = "closed", i.$dialog.find("[mdui-dialog-cancel]").each(function () {
                    e(this).on("click", function () {
        ...
        var a, s, c, d = {
            ...
            if (c) {
                var t = c.$dialog, e = t.children(".mdui-dialog-title"), n = t.children(".mdui-dialog-content"),
        ...
        return t.prototype._doOpen = function () {
            var t = this;
            if (c = t, s || (e.lockScreen(), s = !0), t.$dialog.show(), l(), i.on("resize", e.throttle(function () {
                l()
                ...
                n.indexOf("&mdui-dialog") > -1 && (n = n.replace(/&mdui-dialog/g, "")), location.hash = n + "&mdui-dialog", i.on("hashchange", f)
            }
            ...
            var t = this;
            t.append && t.$dialog.remove(), t.$dialog.removeData("mdui.dialog"), 0 !== o.queue(u).length || c || (a && (e.hideOverlay(), a = null), s && (e.unlockScreen(), s = !1))
        }, t.prototype.handleUpdate = function () {
            l()
        ...
        n.on("click", "[mdui-dialog]", function () {
            var n = e(this), i = s(n.attr("mdui-dialog")), o = i.target;
            delete i.target;
            var a = e(o).eq(0), r = a.data("mdui.dialog");
            r || (r = new t.Dialog(a, i), a.data("mdui.dialog", r)), r.open()
        })
    }), t.dialog = function (n) {
        var i = {
            title: "",
        ...
        n = e.extend({}, i, n || {}), e.each(n.buttons, function (t, i) {
            n.buttons[t] = e.extend({}, o, i)
        });
        var a = "";
        n.buttons.length && (a = '<div class="mdui-dialog-actions ' + (n.stackedButtons ? "mdui-dialog-actions-stacked" : "") + '">', e.each(n.buttons, function (t, e) {
        ...
        "function" == typeof i && (i = "", o = arguments[1], a = arguments[2]), void 0 === o && (o = function () {
        }), void 0 === a && (a = {});
        var s = {confirmText: "ok", history: !0, modal: !1, closeOnEsc: !0};
        return a = e.extend({}, s, a), t.dialog({
            title: i,
            content: n,
            buttons: [{text: a.confirmText, bold: !1, close: !0, onClick: o}],
        ...
        "function" == typeof i && (i = "", o = arguments[1], a = arguments[2], s = arguments[3]), void 0 === o && (o = function () {
        }), void 0 === a && (a = function () {
        }), void 0 === s && (s = {});
        var r = {confirmText: "ok", cancelText: "cancel", history: !0, modal: !1, closeOnEsc: !0};
        return s = e.extend({}, r, s), t.dialog({
            title: i,
            content: n,
            buttons: [{text: s.cancelText, bold: !1, close: !0, onClick: a}, {
                text: s.confirmText,
                bold: !1,
                close: !0,
                onClick: o
        ...
        return t.dialog({
            ...
            content: c,
            buttons: [{
                text: s.cancelText, bold: !1, close: !0, onClick: function (t) {
                    var e = t.$dialog.find(".mdui-textfield-input").val();
                    a(e, t)
                }
            }, {
                text: s.confirmText, bold: !1, close: !0, onClick: function (t) {
                    var e = t.$dialog.find(".mdui-textfield-input").val();
                    o(e, t)
                }
            }],
            ...
            onOpen: function (e) {
                ...
                t.updateTextFields(n), n[0].focus(), "text" === s.type && !0 === s.confirmOnEnter && n.on("keydown", function (t) {
                    if (13 === t.keyCode) {
        ...
        function t(t) {
            var e, n, o, a = t.$target[0].getBoundingClientRect(), s = c() ? 14 : 24, r = t.$tooltip[0].offsetWidth,
                d = t.$tooltip[0].offsetHeight;
            switch (o = t.options.position, -1 === ["bottom", "top", "left", "right"].indexOf(o) && (o = a.top + a.height + s + d + 2 < i.height() ? "bottom" : s + d + 2 < a.top ? "top" : s + r + 2 < a.left ? "left" : a.width + s + r + 2 < i.width() - a.left ? "right" : "bottom"), o) {
                case"bottom":
                    e = r / 2 * -1, n = a.height / 2 + s, t.$tooltip.transformOrigin("top center");
                    break;
                case"top":
                    e = r / 2 * -1, n = -1 * (d + a.height / 2 + s), t.$tooltip.transformOrigin("bottom center");
                    break;
                case"left":
                    e = -1 * (r + a.width / 2 + s), n = d / 2 * -1, t.$tooltip.transformOrigin("center right");
                    break;
                case"right":
                    e = a.width / 2 + s, n = d / 2 * -1, t.$tooltip.transformOrigin("center left")
            }
        ...
        function n(t, n) {
            var i = this;
            if (i.$target = e(t).eq(0), i.$target.length) {
                var s = i.$target.data("mdui.tooltip");
                if (s) return s;
                i.options = e.extend({}, o, n || {}), i.state = "closed", i.$tooltip = e('<div class="mdui-tooltip" id="' + e.guid() + '">' + i.options.content + "</div>").appendTo(document.body), i.$target.on("touchstart mouseenter", function (t) {
        ...
        return n.prototype._doOpen = function () {
            var t = this;
            t.state = "opening", r("open", "tooltip", t, t.$target), t.$tooltip.addClass("mdui-tooltip-open").transitionEnd(function () {
                d(t)
            })
            ...
            if ("opening" !== i.state && "opened" !== i.state) {
                ...
                e.extend(i.options, s(i.$target.attr("mdui-tooltip"))), n && e.extend(i.options, n), o.content !== i.options.content && i.$tooltip.html(i.options.content), t(i), i.options.delay ? i.timeoutId = setTimeout(function () {
                    i._doOpen()
                }, i.options.delay) : (i.timeoutId = !1, i._doOpen())
            }
        }, n.prototype.close = function () {
            var t = this;
            t.timeoutId && (clearTimeout(t.timeoutId), t.timeoutId = !1), "closing" !== t.state && "closed" !== t.state && (t.state = "closing", r("close", "tooltip", t, t.$target), t.$tooltip.removeClass("mdui-tooltip-open").transitionEnd(function () {
                d(t)
            }))
        ...
        n.on("touchstart mouseover", "[mdui-tooltip]", function () {
            var n = e(this), i = n.data("mdui.tooltip");
            if (!i) {
                var o = s(n.attr("mdui-tooltip"));
                i = new t.Tooltip(n, o), n.data("mdui.tooltip", i)
            }
        })
    }), function () {
        function i(t, n) {
            var i = this;
            if (i.message = t, i.options = e.extend({}, r, n || {}), i.message) {
                i.state = "closed", i.timeoutId = !1;
                var o = "", a = "";
                0 === i.options.buttonColor.indexOf("#") || 0 === i.options.buttonColor.indexOf("rgb") ? o = 'style="color:' + i.options.buttonColor + '"' : "" !== i.options.buttonColor && (a = "mdui-text-color-" + i.options.buttonColor), i.$snackbar = e('<div class="mdui-snackbar"><div class="mdui-snackbar-text">' + i.message + "</div>" + (i.options.buttonText ? '<a href="javascript:void(0)" class="mdui-snackbar-action mdui-btn mdui-ripple mdui-ripple-white ' + a + '" ' + o + ">" + i.options.buttonText + "</a>" : "") + "</div>").appendTo(document.body), i._setPosition("close"), i.$snackbar.reflow().addClass("mdui-snackbar-" + i.options.position)
            }
        }
        ...
        i.prototype._setPosition = function (t) {
            ...
            e = "bottom" === a || "top" === a ? "-50%" : "0", "open" === t ? n = "0" : ("bottom" === a && (n = o), "top" === a && (n = -o), "left-top" !== a && "right-top" !== a || (n = -o - 24), "left-bottom" !== a && "right-bottom" !== a || (n = o + 24)), i.$snackbar.transform("translate(" + e + "," + n + "px)")
            ...
            var t = this;
            t.message && "closing" !== t.state && "closed" !== t.state && (t.timeoutId && clearTimeout(t.timeoutId), t.options.closeOnOutsideClick && n.off(a.start, c), t.state = "closing", t.options.onClose(), t._setPosition("close"), t.$snackbar.transitionEnd(function () {
        ...
        var n = function () {
            ...
            var i, o = e(t);
            i = o.hasClass("mdui-spinner-colorful") ? n("1") + n("2") + n("3") + n("4") : n(), o.html(i)
        };
        ...
        t.mutation("[mdui-panel]", function () {
            var n = e(this), i = n.data("mdui.panel");
            if (!i) {
                var o = s(n.attr("mdui-panel"));
                i = new t.Panel(n, o), n.data("mdui.panel", i)
            }
        })
    }), t.Menu = function () {
        function t(t, s, r) {
            var c = this;
            if (c.$anchor = e(t).eq(0), c.$anchor.length) {
                var d = c.$anchor.data("mdui.menu");
                if (d) return d;
                c.$menu = e(s).eq(0), c.$anchor.siblings(c.$menu).length && (c.options = e.extend({}, o, r || {}), c.state = "closed", c.isCascade = c.$menu.hasClass("mdui-menu-cascade"), "auto" === c.options.covered ? c.isCovered = !c.isCascade : c.isCovered = c.options.covered, c.$anchor.on("click", function () {
                    c.toggle()
        ...
        var o = {
            ...
            var e, n, o, a, s, r, c = i.height(), d = i.width(), u = t.options.gutter, l = t.isCovered,
                f = t.options.fixed, p = t.$menu.width(), h = t.$menu.height(), m = t.$anchor,
                v = m[0].getBoundingClientRect(), g = v.top, b = v.left, x = v.height, y = v.width, $ = c - g - x,
                w = d - b - y, C = m[0].offsetTop, k = m[0].offsetLeft;
            if (o = "auto" === t.options.position ? $ + (l ? x : 0) > h + u ? "bottom" : g + (l ? x : 0) > h + u ? "top" : "center" : t.options.position, a = "auto" === t.options.align ? w + y > p + u ? "left" : b + y > p + u ? "right" : "center" : t.options.align, "bottom" === o) r = "0", n = (l ? 0 : x) + (f ? g : C); else if ("top" === o) r = "100%", n = (l ? x : 0) + (f ? g - h : C - h); else {
                r = "50%";
                var O = h;
                t.isCascade || h + 2 * u > c && (O = c - 2 * u, t.$menu.height(O)), n = (c - O) / 2 + (f ? 0 : C - g)
            }
            if (t.$menu.css("top", n + "px"), "left" === a) s = "0", e = f ? b : k; else if ("right" === a) s = "100%", e = f ? b + y - p : k + y - p; else {
                s = "50%";
                var T = p;
                p + 2 * u > d && (T = d - 2 * u, t.$menu.width(T)), e = (d - T) / 2 + (f ? 0 : k - b)
            }
            t.$menu.css("left", e + "px"), t.$menu.transformOrigin(s + " " + r)
        }, s = function (t) {
            var e, n, o, a, s, r, c = t.parent(".mdui-menu-item"), d = i.height(), u = i.width(), l = t.width(),
                f = t.height(), p = c[0].getBoundingClientRect(), h = p.width, m = p.height, v = p.left, g = p.top;
            o = d - g > f ? "bottom" : g + m > f ? "top" : "bottom", a = u - v - h > l ? "left" : v > l ? "right" : "left", "bottom" === o ? (r = "0", e = "0") : "top" === o && (r = "100%", e = -f + m), t.css("top", e + "px"), "left" === a ? (s = "0", n = h) : "right" === a && (s = "100%", n = -l), t.css("left", n + "px"), t.transformOrigin(s + " " + r)
        }, c = function (t) {
        ...
        var f = function (t) {
            t.$menu.removeClass("mdui-menu-closing"), "opening" === t.state && (t.state = "opened", r("opened", "menu", t, t.$menu)), "closing" === t.state && (t.state = "closed", r("closed", "menu", t, t.$menu), t.$menu.css({
                top: "",
                left: "",
                width: "",
                position: "fixed"
        ...
        return t.prototype.open = function () {
            var t = this;
            "opening" !== t.state && "opened" !== t.state && (t.state = "opening", r("open", "menu", t, t.$menu), a(t), t.$menu.css("position", t.options.fixed ? "fixed" : "absolute").addClass("mdui-menu-open").transitionEnd(function () {
                f(t)
            }))
        }, t.prototype.close = function () {
            var t = this;
            "closing" !== t.state && "closed" !== t.state && (t.state = "closing", r("close", "menu", t, t.$menu), t.$menu.find(".mdui-menu").each(function () {
                d(e(this))
        ...
        n.on("click", "[mdui-menu]", function () {
            var n = e(this), i = n.data("mdui.menu");
            if (!i) {
                var o = s(n.attr("mdui-menu")), a = o.target;
                delete o.target, i = new t.Menu(n, a, o), n.data("mdui.menu", i), i.toggle()
            }
        })
    }), t.JQ = e, t
});
